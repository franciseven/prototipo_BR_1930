...
configurarFiltroDinamico(
	'materias-jornalisticas-select',
	{
		autor: 'materias-jornalisticas-autor-select',
		jornal: 'materias-jornalisticas-jornal-select',
		tipo: 'materias-impressas-tipo-select'
	},
	'materia-jornalistica-input'
);

configurarFiltroDinamico(
	'revistas-select',
	{
		editora: 'revistas-editora-select',
		assunto: 'revistas-assunto-select',
		titulo: 'revistas-titulo-select'
	},
	'revistas-input'
);